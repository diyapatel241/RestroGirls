...
$paswrd = $_POST['password_reg'];
$paswrdcon = $_POST['con_password_reg'];

$sql = "INSERT INTO `mishtidb`.`registrationform` (`name`, `email`, `password`, `confirm passsword`, `date and time`) VALUES ('$username', '$email', '$paswrd', '$paswrdcon', current_timestamp());";
...
<section class="registermodal">
	<div id="modal2" class="modal">
	    <div class="modal-content center">
	      ...
	      <form action="register-modal.php" method="POST">
